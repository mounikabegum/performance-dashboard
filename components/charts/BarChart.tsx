...
import { useBarRenderer } from '@/hooks/useChartRenderer';
...
export default function BarChart({
  ...
  // renderer will measure canvas size itself
  useBarRenderer(canvasRef as React.RefObject<HTMLCanvasElement | null>, dataRef as React.MutableRefObject<Point[]>, height, running);
